...
if SERVER then
	resource.AddWorkshop("924744897")
end

AddCSLuaFile()

SWEP.PrintName			= "Spinner"	

SWEP.Author = "Server"
SWEP.Purpose = "www.lbgaming.net"
...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		if d > 0 then
			draw.WordBox(8, ScrW()*0.3, ScrH()-50, tostring(d).." RPM", "Trebuchet24", Color(0,0,0,100), Color(255,255,255,255))
		end
	end
