...
SWEP.BlowbackBoneMods = {
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1.423, 0, 0) }
}
...
SWEP.ViewModel				= "models/weapons/v_mwr_g3.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_g3.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_g3.Single")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 1200			-- This is in Rounds Per Minute
SWEP.Primary.RPM_Semi			= 1200			-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-2.596, -3.641, 1.12)
SWEP.SightsAng = Vector(0.009, 0.05, 0)
SWEP.RunSightsPos = Vector (1.879, 0, -4.761)
SWEP.RunSightsAng = Vector (-7.2, 53.099, -30.601)
SWEP.InspectPos = Vector(9.68, 0, 3.16)
SWEP.InspectAng = Vector(-9.801, 44.2, -6.1)
