...
SWEP.ViewModel				= "models/weapons/v_mwr_mp5sd.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_mp5sd.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-4.171, -1.76, 1.32)
SWEP.SightsAng = Vector(0.699, 0.2, 0)
SWEP.RunSightsPos = Vector (0.839, 0, -1.361)
SWEP.RunSightsAng = Vector (-13.801, 47.5, -23.9)
SWEP.InspectPos = Vector(5.8, 0, 2.44)
SWEP.InspectAng = Vector(4.4, 23.299, 12.5)
