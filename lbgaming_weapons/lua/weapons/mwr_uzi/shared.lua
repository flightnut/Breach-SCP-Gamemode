...
SWEP.BlowbackBoneMods =  {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-3.373, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.ViewModel				= "models/weapons/v_mwr_uzi.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_uzi.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_uzi.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.931, 0, -0.04)
SWEP.SightsAng = Vector(1.7, 0.1, 0)
SWEP.RunSightsPos = Vector (5.639, 0, 3.68)
SWEP.RunSightsAng = Vector (-43.701, 32.9, -25.201)
SWEP.InspectPos = Vector(10.199, -4.56, -0.16)
SWEP.InspectAng = Vector(7.699, 46.099, 7.5)
