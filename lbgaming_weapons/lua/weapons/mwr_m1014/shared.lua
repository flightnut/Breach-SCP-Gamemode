...
SWEP.ViewModel				= "models/weapons/v_mwr_m1014.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m1014.mdl"	-- Weapon world model
SWEP.Base 				= "tfa_shotty_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("mwr_m1014.Single")		-- script that calls the primary fire sound
SWEP.Primary.RPM				= 321		-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-3.32, -2.08, 1.919)
SWEP.SightsAng = Vector(0.2, 0, 0)
SWEP.RunSightsPos = Vector(0.92, 0, -2.401)
SWEP.RunSightsAng = Vector(-7.401, 49.5, -27.701)
SWEP.InspectPos = Vector(6.23, -1.961, 3.68)
SWEP.InspectAng = Vector(-6.1, 28.7, 15.699)
