...
SWEP.PrintName				= "Barrett .50 Cal"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_mwr_barrett.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_barrett.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_barrett.Single")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 888			-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-4.64, -2.961, 0.879)
SWEP.SightsAng = Vector(1.899, 0.2, 0)
SWEP.RunSightsPos = Vector (-1.081, 0, -2.161)
SWEP.RunSightsAng = Vector (-8.801, 46.4, -35.701)
SWEP.InspectPos = Vector(9.96, -7.481, 3.039)
SWEP.InspectAng = Vector(10.6, 48.5, 15.3)
...
SWEP.ViewModelBoneMods = {
	["j_handle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -33.151) }
}
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "tag_weapon", rel = "", pos = Vector(-2.096, 0.14, 6.644), angle = Angle(0, 180, 0), size = Vector(0.526, 0.526, 0.526), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
