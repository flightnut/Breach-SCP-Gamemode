...
SWEP.ViewModel				= "models/weapons/v_mwr_ak74u.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_ak74u.mdl"	-- Weapon world model
SWEP.Base					= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater 		= false

SWEP.Primary.Sound				= Sound("mwr_ak74u.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.757, -5.361, 0.839)
SWEP.SightsAng = Vector(-0.301, 0.1, 0)
SWEP.RunSightsPos = Vector (0.92, 0, -2.12)
SWEP.RunSightsAng = Vector (-10.2, 43, -26.4)
SWEP.InspectPos = Vector(14.159, 0, 4)
SWEP.InspectAng = Vector(9, 49.5, 21.6)
