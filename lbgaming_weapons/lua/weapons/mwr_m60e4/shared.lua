...
SWEP.BlowbackBoneMods =  {
	["j_handle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 33.952) }
}
...
SWEP.ViewModel				= "models/weapons/v_mwr_m60.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m60.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_m60.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.59, -7.761, 0.561)
SWEP.SightsAng = Vector(0.4, 0.029, 0)
SWEP.RunSightsPos = Vector (2.519, 0, -3.56)
SWEP.RunSightsAng = Vector (-7.301, 59.2, -24.4)
SWEP.InspectPos = Vector(6.559, 0, -1.081)
SWEP.InspectAng = Vector(20.1, 30.1, 8.1)
