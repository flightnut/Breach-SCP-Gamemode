...
SWEP.ViewModel				= "models/weapons/v_mwr_m16a4.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m16a4.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_m16.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3, -2.721, -0.02)
SWEP.SightsAng = Vector(0.2, 0, 0)
SWEP.RunSightsPos = Vector (1.72, 0, -3.961)
SWEP.RunSightsAng = Vector (-5.901, 45.299, -29.8)
SWEP.InspectPos = Vector(9.319, 0, 2.92)
SWEP.InspectAng = Vector(6, 49.9, 10.6)
