...
SWEP.BlowbackBoneMods =  {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-5.16, 0, 0), angle = Angle(0, 0, 0) },
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-0.87, 0, 0) }
}
...
SWEP.PrintName				= "MP-44"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_mwr_mp44.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_mp44.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_mp44.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.77, -6.921, 0.74)
SWEP.SightsAng = Vector(0.4, 0, 0)
SWEP.RunSightsPos = Vector (0.72, 0, -2.881)
SWEP.RunSightsAng = Vector (-12.101, 39.099, -38.701)
SWEP.InspectPos = Vector(9.399, 0, 2.319)
SWEP.InspectAng = Vector(-8.4, 53.299, -1.201)
