...
SWEP.BlowbackBoneMods =  {
	["j_bolt2"] = { scale = Vector(1, 1, 1), pos = Vector(-6.126, 0, 0), angle = Angle(0, 0, 0) },
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-1.062, 0, 0) }
}
...
SWEP.ViewModel				= "models/weapons/v_mwr_ak47.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_ak47.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_ak47.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.921, -5.441, 0.899)
SWEP.SightsAng = Vector(0.1, 0.039, 0)
SWEP.RunSightsPos = Vector (0.72, 0, -3.201)
SWEP.RunSightsAng = Vector (-14.9, 30.2, -36.5)
SWEP.InspectPos = Vector(12.52, 0, 1.679)
SWEP.InspectAng = Vector(8.6, 46, 16.2)
