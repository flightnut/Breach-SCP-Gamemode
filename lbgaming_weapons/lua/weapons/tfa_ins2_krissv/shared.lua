...
SWEP.Manufacturer 			= "KRISS" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_krissv.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_krissv.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.579, -4.887, 1.44)
SWEP.IronSightsAng = Vector(0, -0.051, 0)

--PO4X

SWEP.IronSightsPos_PO4X = Vector(-3.477, -3.809, 0.814)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0.07)


--Elcan
SWEP.IronSightsPos_C79 = Vector(-3.556, -3.809, 0.264)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0.07)

--2X RDS

SWEP.IronSightsPos_2XRDS = Vector(-3.55, -6.216, 0.685)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, -0.009)

--RDS

SWEP.IronSightsPos_RDS = Vector(-3.55, -8.289, 0.685)
SWEP.IronSightsAng_RDS = Vector(0, 0, -0.009)

--Kobra

SWEP.IronSightsPos_Kobra = Vector(-3.55, -8.435, 0.777)
SWEP.IronSightsAng_Kobra = Vector(0.995, 0, -0.009)

--EOTech

SWEP.IronSightsPos_EOTech = Vector(-3.55, -8.346, 0.686)
SWEP.IronSightsAng_EOTech = Vector(0, 0, -0.009)
...
SWEP.WElements = {
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_elcan.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-37.209, 0.207, -5.203), angle = Angle(0, 0, 0), size = Vector(0.61, 0.61, 0.61), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(10.362, 0.8, 0.95), angle = Angle(0, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(3.423, 0.259, -13.523), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_kobra.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-40.245, 0.112, -21.621), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_po.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-75.335, 0.086, -10.36), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["wm"] = { type = "Model", model = "models/weapons/tfa_ins2/w_krissv.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.001, 1.003, 0.781), angle = Angle(-19.494, -17, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-31.618, 0.578, 13.887), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_aimpoint.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-54.214, 0.563, -10.667), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_aimpoint.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "wm", pos = Vector(-54.214, 0.563, -10.667), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
