...
SWEP.BlowbackBoneMods = {
	["j_bolt"] = { scale = Vector(1, 1, 1), pos = Vector(-3.477, 0, 0), angle = Angle(0, 0, 0) },
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-2.984, 0, 0) }
}
...
SWEP.ViewModel				= "models/weapons/v_mwr_m9.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m9.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_m9.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-2.401, 0, 1.519)
SWEP.SightsAng = Vector(-1.3, 0.1, 0)
SWEP.RunSightsPos = Vector (1.639, -9.16, -10.16)
SWEP.RunSightsAng = Vector (50.7, -6, 0)
SWEP.InspectPos = Vector(8.8, -3.441, -0.921)
SWEP.InspectAng = Vector(14.399, 38.299, 14.8)
