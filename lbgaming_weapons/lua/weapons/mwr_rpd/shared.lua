...
SWEP.ViewModel				= "models/weapons/v_mwr_rpd.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_rpd.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_rpd.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.701, -2.441, 1.383)
SWEP.SightsAng = Vector(0.6, 0, 0)
SWEP.RunSightsPos = Vector (1.039, 0, -2.08)
SWEP.RunSightsAng = Vector (-13.9, 45, -29.4)
SWEP.InspectPos = Vector(10.76, 0, 3.88)
SWEP.InspectAng = Vector(-3.401, 43.799, 7.599)
...
SWEP.ViewModelBoneMods = {
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(-0.355, 0, 0), angle = Angle(0, 0, 0) }
}
