...
SWEP.ViewModel				= "models/weapons/v_mwr_m4a1.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m4a1.mdl"	-- Weapon world model
SWEP.Base					= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater 		= false

SWEP.Primary.Sound				= Sound("mwr_m4a1.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.106, 0, 1.004)
SWEP.SightsAng = Vector(-0.801, 0, 0)
SWEP.RunSightsPos = Vector (0.4, 0, -0.721)
SWEP.RunSightsAng = Vector (-16.5, 46.9, -31.8)
SWEP.InspectPos = Vector(7.639, -2.12, 1.96)
SWEP.InspectAng = Vector(6.9, 48.7, 7.099)
...
SWEP.VElements = {
	["element_name"] = { type = "Sprite", sprite = "sprites/redglow2", bone = "tag_weapon", rel = "", pos = Vector(3.611, -0.005, 4.703), size = { x = 0.197, y = 0.197 }, color = Color(255, 255, 255, 255), nocull = true, additive = true, vertexalpha = true, vertexcolor = true, ignorez = false}
}
