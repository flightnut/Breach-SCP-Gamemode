...
SWEP.ViewModel				= "models/weapons/v_mwr_m249saw.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m249saw.mdl"	-- Weapon world model
SWEP.Base					= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater		= false

SWEP.Primary.Sound				= Sound("mwr_m249.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.52, -1.88, 2.44)
SWEP.SightsAng = Vector(0, 0.019, 0)
SWEP.RunSightsPos = Vector (1.08, 0, -0.801)
SWEP.RunSightsAng = Vector (-12.7, 47.7, -23.9)
SWEP.InspectPos = Vector(11.039, -6.16, 1.759)
SWEP.InspectAng = Vector(15.5, 43.299, 17.2)
