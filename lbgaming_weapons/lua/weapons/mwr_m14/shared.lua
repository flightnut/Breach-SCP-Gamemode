...
SWEP.ViewModel				= "models/weapons/v_mwr_m14.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_m14.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-4.915, -5.361, 2.44)
