...
SWEP.ViewModel				= "models/weapons/v_mwr_g36c.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_g36c.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_g36c.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-3.495, -3.641, 0.349)
SWEP.SightsAng = Vector(-0.601, 0.029, 0)
SWEP.RunSightsPos = Vector (0.879, 0, -3.76)
SWEP.RunSightsAng = Vector (-11.7, 38.799, -31.601)
SWEP.InspectPos = Vector(15.84, -7.64, 0.36)
SWEP.InspectAng = Vector(13.699, 58.799, 10.5)
