...
SWEP.Category				= "TFA L4D2"	 --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "CheyTac M200" -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound					= Sound("TFA_L4D2_CTM200.1") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_l4d2/c_ctm200.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_l4d2/w_ctm200.mdl" -- Weapon world model path
...
--[[SCOPES]]--
SWEP.IronSightsSensitivity = nil --Useful for a RT scope.  Change this to 0.25 for 25% sensitivity.  This is if normal FOV compenstaion isn't your thing for whatever reason, so don't change it for normal scopes.
SWEP.BoltAction = true --Unscope/sight after you shoot?
SWEP.BoltAction_Forced = true --Unscope/sight after you shoot 3d?
...
SWEP.IronSightsPos = Vector(-5.341, -5.0, 0.439)
...
--[[ATTACHMENTS]]--
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "body", rel = "", pos = Vector(0.02, 0.617, 7.3725), angle = Angle(0, 90, 0), size = Vector(0.34, 0.34, 0.34), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, bonemerge = false}
}
