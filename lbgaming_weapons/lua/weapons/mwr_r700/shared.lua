...
SWEP.ViewModel				= "models/weapons/v_mwr_rem700.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_r700.mdl"	-- Weapon world model
SWEP.Base 				= "tfa_shotty_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("mwr_r700.Single")		-- script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-4.72, -3, 1.121)
SWEP.SightsAng = Vector(0.8, -0.301, 0)
SWEP.RunSightsPos = Vector(-1.88, 0, -2.641)
SWEP.RunSightsAng = Vector(-9.4, 36.099, -34.201)
SWEP.InspectPos = Vector(7.76, 0, 1.36)
SWEP.InspectAng = Vector(2.799, 36.9, 10.199)
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "tag_weapon", rel = "", pos = Vector(-9.933, 0.086, 4.139), angle = Angle(0, 180, 0), size = Vector(0.31, 0.31, 0.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
