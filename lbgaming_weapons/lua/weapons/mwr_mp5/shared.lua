...
SWEP.ViewModel				= "models/weapons/v_mwr_mp5.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_mwr_mp5.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("mwr_mp5.Single")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-4.191, -2.201, 0.54)
SWEP.SightsAng = Vector(0.4, 0, 0)
SWEP.RunSightsPos = Vector (0.68, 0, -0.52)
SWEP.RunSightsAng = Vector (-15.301, 41.099, -25.9)
SWEP.InspectPos = Vector(6.96, 0, -4.72)
SWEP.InspectAng = Vector(28.1, 17.1, 13.199)
SWEP.Offset = {
        Pos = {
        Up = 0,
        Right = 0,
...
SWEP.ViewModelBoneMods = {
	["tag_weapon"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.477, 0.995), angle = Angle(0, 0, 0) }
}
