...
if CLIENT then
	-- SWEP.WepSelectIcon 	= surface.GetTextureID("breach/wep_keycard2") --NO ICONS
...
SWEP.ViewModel		= "models/weapons/c_playingcardscpn.mdl"
SWEP.WorldModel		= "models/weapons/w_playingcardscpn.mdl"
