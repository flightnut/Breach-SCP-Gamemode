	...
	researchers = {
		...
		roles = {
			...
			{name = ROLES.ROLE_MEDIC,
			 team = TEAM_SCI,
			 weapons = {"keycard_level2", "item_ultramedkit"},
	...
	security = {
		...
		roles = {
			{name = ROLES.ROLE_SECURITY,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level2", "item_radio", "weapon_stunstick", "weapon_mtf_tmp"},
			...
			{name = ROLES.ROLE_CSECURITY,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level4", "item_radio", "weapon_stunstick", "weapon_mtf_p90"},
			 showweapons = {"Keycard Level 4", "Radio", "Stunstick", "P90"},
			 ammo = {{"SMG1", 200}},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.9,
			...
			{name = ROLES.ROLE_MTFGUARD,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level3", "item_radio", "weapon_stunstick", "weapon_mtf_ump"},
			...
			{name = ROLES.ROLE_CHAOSSPY,
			 team = TEAM_CHAOS,
			 weapons = {"keycard_level3", "item_radio", "weapon_stunstick", "weapon_mtf_ump45"},
			 showweapons = {"Keycard Level 3", "Radio", "Stunstick", "UMP"},
			 ammo = {{"SMG1", 200}},
			 health = 100,
			 armor = 0,
			...
			{name = ROLES.ROLE_MTFMEDIC,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level3", "item_radio", "item_ultramedkit", "weapon_stunstick", "weapon_mtf_ump45"},
			...
			{name = ROLES.ROLE_MTFL,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level4", "item_radio", "weapon_stunstick", "weapon_mtf_mp5"},
			 showweapons = {"Keycard Level 4", "Radio", "Stunstick", "FAMAS"},
			 ammo = {{"SMG1", 200}},
			 health = 100,
			 armor = 0,
			 walkspeed = 0.87,
			...
			{name = ROLES.ROLE_MTFCOM,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level4", "item_radio", "weapon_stunstick", "weapon_chaos_famas"},
			...
			{name = ROLES.ROLE_SD,
			 team = TEAM_GUARD,
			 weapons = {"keycard_level5", "item_radio", "weapon_stunstick", "weapon_mtf_deagle"},
			 showweapons = {"Keycard Level 5", "Radio", "Stunstick", "Desert Eagle"},
			 ammo = {{"Pistol", 105}},
			 health = 100,
			 armor = 0,
			 walkspeed = 1,
	...
	support = {
		...
		roles = {
			{name = ROLES.ROLE_MTFNTF,
			 ...
			 vest = "armor_ntf",
			 models = RESEARCHERMODELS,
			 showmodel = "models/player/pmc_4/pmc__06.mdl",
			 pmcolor = nil,
			 flashlight = true,
			 level = 3,
			 max = 3
			...
			{name = ROLES.ROLE_CHAOS,
			 team = TEAM_CHAOS,
			 weapons = {"keycard_level4", "item_radio", "weapon_stunstick", "weapon_chaos_ak47"},
