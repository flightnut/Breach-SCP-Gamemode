...
polski.starttexts = {
	...
	ROLE_CSECURITY = {
		...
		{"Twoim celem jest znalezienie wszystkich naukowców i eliminacja Klasy D",
		"Eskortuj ich do lądowiska",
		"Wydawaj polecenia ochroniażom ci przydzielonym"}
	},
	ROLE_MTFGUARD = {
	...
	ROLE_MTFMEDIC = {
		"Jesteś Medykiem MTF",
		{"Twoim celem jest wspieranie innych ochroniażów i naukowców",
	...
	ROLE_MTFL = {
		...
		"Jeśli Dowódca przydzieli ci ochroniaży to wydawaj im polecenia",
	...
	ROLE_CHAOSCOM = {
		...
		"Musicie zabić wszystkich ochroniaży MTF",
...
polski.ROLES.ROLE_CSECURITY = "Dowódca ochroniaży"
